...
export function ProcessoDocumentosTab({ processo, onUpload }: ProcessoDocumentosTabProps) {
  const { documentos, loading } = useDocumentos(undefined, processo.id);
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Documentos do Processo ({documentos.length})</h3>
        {canCreate && onUpload && (
